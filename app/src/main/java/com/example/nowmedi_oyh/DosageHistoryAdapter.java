...
public class DosageHistoryAdapter extends RecyclerView.Adapter<DosageHistoryAdapter.CustomViewHolder> {
    ...
    @NonNull
    @Override
    public DosageHistoryAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DosageHistoryAdapter.CustomViewHolder holder, int position) {
